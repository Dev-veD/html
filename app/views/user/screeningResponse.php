...
<form id="regForm">
                    ...
                    <div class="col col-md-4 text-center">
                        ...
                        <div class="text-left">
                            ...
                            <ul>
                                ...
                                <li>
                                    <?php
                                    if ($data['responsed']['dryCough'] == "yes") {
                                    ?>
                                ...
                                <li>
                                    <?php
                                    if ($data['responsed']['breatheTrouble'] == "yes") {
                                    ?>
                                ...
                                <li>
                                    <?php
                                    if ($data['responsed']['chestPain'] == "yes") {
                                    ?>
                                ...
                                <li>
                                    <?php
                                    if ($data['responsed']['conditions'] == "yes") {
                                    ?>
                                ...
                                <li>
                                    <?php
                                    if ($data['responsed']['traveled'] == "yes") {
                                    ?>
                                ...
                                <li>
                                    <?php
                                    if ($data['responsed']['covidCity'] == "yes") {
                                    ?>
                                ...
                                <li>
                                    <?php
                                    if ($data['responsed']['careFacility'] == "yes") {
                                    ?>
                                ...
                                <li>
                                    <?php
                                    if ($data['responsed']['covidContact'] == "yes") {
                                    ?>
    ...
    <p><b>
            ...
            </base64_decode><br> The test results and suggestions are completely based on guidelines provided by CDC. Developers do not hold any responsibility of the result and its following consequences.Please be carefull and take action according to your conscience. Results are just an advice.</p>
